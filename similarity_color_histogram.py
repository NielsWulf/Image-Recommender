        ...
        for start_idx in range(0, total_images, batch_size):
            ...
            for image_uuid, file_path in batch:
                ...
                try:
                    ...
                    metadata_batch.append(
                        {"uuid": image_uuid, "color_histogram": color_hist}
                    )
            ...
            if metadata_batch:
                combined_data.update(
                    {meta["uuid"]: meta["color_histogram"] for meta in metadata_batch}
                )
...
if __name__ == "__main__":
    ...
    generate_color_histograms(
        db_path, batch_size, combined_pickle_path, checkpoint_path
    )
